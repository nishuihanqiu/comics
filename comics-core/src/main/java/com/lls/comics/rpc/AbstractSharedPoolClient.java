...
public abstract class AbstractSharedPoolClient extends AbstractClient {
  ...
  private void createChannels() {
    ...
    initConnections(url.getBooleanArgument(URLParamType.ASYNC_INITCONNECTION.getName(), URLParamType.ASYNC_INITCONNECTION.getBooleanValue()));
  }
  ...
  protected Channel getChannel() throws ComicsException {
    ...
    for (int i = index; i < connections + index; i++) {
      ...
      factory.rebuildChannel(channel);
    }
